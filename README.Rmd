...
La duración total estimada es de **5 días (jornadas de 4 horas, total 20 horas)**.  
...
- Wu, Qiusheng (2025). Introducción a la Programación GIS Una Guía Práctica de Python para Herramientas Geoespaciales de Código Abierto.
