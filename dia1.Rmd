---
title: "Curso QGIS aplicado a Sismología y Geología"
subtitle: "Día 1 · Fundamentos y visualización de datos geoespaciales"
author: "José Ramón Martínez-Batlle"
institute: "Observatorio Sismológico Loyola"
date: "`r Sys.Date()`"
output:
...
```{css, echo=F}
/* Aumentar ligeramente la tipografía base */
.remark-slide-content {
  font-size: 150%;
}

/* Ajustes opcionales: listas y código un pelín más legibles */
...
## ¿Por qué QGIS en un observatorio sismológico?
...
## ¿Por qué es crítico en sismología?
...
## Regla práctica para el observatorio
...
# Aplicación directa al Observatorio
...
# Sugerencias y validación de prácticas

---

## Evaluación de tus ejercicios propuestos
